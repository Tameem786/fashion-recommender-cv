...
def extract_img(image, transformation):
    ...
    try:
        ...
        print(f"Error loading mode: {error}")
        return None
...
def visualize_features(feature_vector):
    # Reshape and visualize the features
    feature_map = feature_vector.reshape(512, 1)  # Adjust the shape for visualization if needed
